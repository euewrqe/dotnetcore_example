        ...
        private static List<Product> GetProducts()
        {
            var products = new List<Product> {
                ...
                new Product
                {
                    ...
                    Description="You will have endless fun with this one quartersized fire truck.",
                ...
                new Product
                {
                    ...
                    Description="This fun toy truck can be used to tow other trucksthat are not as big.",
                ...
                new Product
                {
                    ...
                    Description="Is it a boat or a ship. Let this floting vehicle decide by using its " + "artifically interlligent intelligent computer brain",
